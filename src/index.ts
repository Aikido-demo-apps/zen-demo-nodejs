...
app.get('/test_user_blocking', (c) => {
  // This is a very long string with over 150 characters to test the code quality checks - this is a test - this is a test - this is a test - this is a test
...
app.post('/api/create', async (c) => {
  try {
    ...
    const rowsCreated = await DatabaseHelper.createPetByName(
      createRequest.name,
    );
